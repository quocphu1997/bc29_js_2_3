...
function tinhluong() {
  ...
  var day = document.getElementById("day").value; //đầu vào
  var salary = 0; //gán đầu ra
  salary = day * salaryPerday; // xử lý
  document.getElementById("kq").innerHTML = "Tổng lương là: " + salary + "đ"; //in kết quả đầu ra
...
// hàm tính
function gttb() {
  var a = document.getElementById("a").value; //đầu vào
  var b = document.getElementById("b").value; //đầu vào
  var c = document.getElementById("c").value; //đầu vào
  var d = document.getElementById("d").value; //đầu vào
  var e = document.getElementById("e").value; //đầu vào
  //xử lý
  ...
  document.getElementById("gt_tb").innerHTML =
    "Giá trị trung bình là: " + gt_tb; //in kết quả đầu ra
...
function quydoi() {
  ...
  var usd = document.getElementById("_usd").value * 1; //đầu vào
  //xử lý
  var quydoi = 0; // gán
  quydoi = vnd * usd;
  document.getElementById("quydoi").innerHTML =
    "Giá trị quy đổi là: " + quydoi + "đ"; ////in kết quả đầu ra
...
// hàm tính
function dt() {
  var cd = document.getElementById("cdai").value; //đầu vào chiều dài
  var cr = document.getElementById("crong").value; //đầu vào chiều rộng
  cd = parseInt(cd); //chuyển sang số interger
  cr = parseInt(cr); //chuyển sang số interger
  var _dt = 0;
  _dt = cd * cr;
  document.getElementById("cv_dt").innerHTML =
    "Diện tích hình chữ nhật là: " + _dt + "cm"; //xuất diện tích
}
function cv() {
  var cd = document.getElementById("cdai").value; //đầu vào chiều dài
  var cr = document.getElementById("crong").value; //đầu vào chiều rộng
  ...
  _cv = (cd + cr) * 2;
  document.getElementById("cv_dt").innerHTML =
    "Chu vi hình chữ nhật là: " + _cv + "cm"; //xuất chu vi
}
...
// hàm tính
function tong_two() {
  var n = document.getElementById("n_so").value; // đầu vào 2 chữ số
  //   xử lý
  ...
  document.getElementById("kq_kyso").innerHTML = "Tổng hai ký số là: " + _tong;////xuất tổng 2 ký số
  console.log(_tong);
}
